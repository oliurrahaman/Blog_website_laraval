        ...
        <div class="container">
            ...
            <div class="row blog-entries element-animate">
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="pt-5">
                        <p>Categories: {{ $blog->category->name }} <a href="#"></a></p>
                    </div>
                ...
                <div class="col-md-12 col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            <img src="{{asset($blog->image)}}" alt="Image Placeholder" class="img-fluid mb-3">
                            <div class="bio-body">
                                <h2>{{ $blog->title }}</h2>
                                <p class="mb-4">Food blog ideas are to a food website what water is to fish. 🐟 </p>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="blog-entry">
                        <a href="single.html" class="img-link">
                            <img src="{{asset($data->image)}}" alt="Image" class="img-fluid">
                        </a>
