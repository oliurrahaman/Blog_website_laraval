...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{\Request::route()->getName() == 'dashboard' ? 'active' : ''}}" href="#" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header {{\Request::route()->getName() == 'category.add' || \Request::route()->getName() == 'category.manage' || \Request::route()->getName() == 'category.edit' ? 'active pcoded-trigger' : ''}}">Custom Components:</h6>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="" data-toggle="modal" data-target="#logoutModal"  onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Oliur Rahaman 2023</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
